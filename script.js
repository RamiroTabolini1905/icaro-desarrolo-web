...
// Agregar en el HTML un boton en el header cuyo unico proposito sea cambiar el color del mismo y realizar la logica para que pueda funcionar como tal (utilizar ID en el header para seleccionarlo y trabajar con el DOM y la propiedad classList de los elementos HTML como se vio en clases. Investigar sobre los metodos 'toggle', 'add', y 'remove' para trabajar con clases de CSS desde JS).
